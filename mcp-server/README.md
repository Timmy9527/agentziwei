...
1. **MCP API Key**: Log in at [ziweai.com](https://ziweai.com), go to **My Reports**, find **MCP Integration**, and click **Generate MCP API Key**. Copy the key (it is shown only once).
